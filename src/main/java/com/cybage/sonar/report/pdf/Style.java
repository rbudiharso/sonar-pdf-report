...
public class Style {
     ...
     */
    public static final Font DASHBOARD_DATA_FONT_2 = new Font(FontFamily.COURIER, 9, Font.NORMAL, BaseColor.DARK_GRAY);

    /**
     * Dashboard metric details font
     */
    public static final Font QUALITY_GATE_TITLE_FONT = new Font(FontFamily.TIMES_ROMAN, 9, Font.NORMAL,
            new BaseColor(6, 12, 76));
    ...
    public static final Font  DASHBOARD_DATA_FILEPATH_FONT_2 = new Font(FontFamily.COURIER, 7, Font.NORMAL,
            BaseColor.WHITE);
